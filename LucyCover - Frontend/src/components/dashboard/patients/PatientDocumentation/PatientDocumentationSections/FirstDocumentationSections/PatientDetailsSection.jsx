    ...
    return (
        <section className={style.PatientFormSection}>
            ...
            <span>
                ...
                <LabelInput controlId='motherAge' label='Wiek' className={style.StandardInput} onInput={SetFormInputHandler} required readonly={isReadonly} value={formInputs.motherAge} />
