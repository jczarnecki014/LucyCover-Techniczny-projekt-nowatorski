    ...
    return (
        <section className={style.PatientFormSection}>
            ...
            <span>
                ...
                {
                    ['Wcześniej','Później'].includes(formInputs.babyBirthTime) && <LabelInput controlId='babyBirthTime_ADDITIONAL' label='O ile' className={style.FullInput} onInput={SetFormInputHandler} />
                }
                ...
                {
                    ['Zabiegowy','Cięcie cesarskie'].includes(formInputs.babyBirthType) && <LabelInput controlId='babyBirthTypeReason' label='Powód takiego porodu' className={style.FullInput} onInput={SetFormInputHandler} />
                }
