    ...
    return (
        <Fragment>
            ...
            <div id={style.ContactInputs} className={style.FormInputs}>
                ...
                <LabelInput className={style.Input} controlId="birthDay" label="Data urodzenia" inputType="date" max={datePickerMax} required  onInput={setPatientInput} value={birthDay} />
